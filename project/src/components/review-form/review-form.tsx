    ...
    >
      ...
      <div className="reviews__rating-form form__rating">
        <input className="form__rating-input visually-hidden" name="rating" value="5" id="5-stars" type="radio"
          onChange={({target}: ChangeEvent<HTMLInputElement>) => setReviewRating(target.value)}
        />
      ...
      <div className="reviews__button-wrapper">
        ...
        <button className="reviews__submit form__submit button" type="submit" disabled={reviewMessage.length < 50}>Submit</button>
      </div>
    </form>
  );
}
